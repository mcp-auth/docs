...
[^4]: Auth0 e Descope suportam tokens de atualização multi-recurso (MRRT), mas não o RFC 8707 completo. O suporte ao indicador de recurso é limitado e não segue o padrão.

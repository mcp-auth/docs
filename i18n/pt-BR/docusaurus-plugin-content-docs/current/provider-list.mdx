...
sidebar_label: Lista de provedores
---
...
[^1]: Indicador de recurso refere-se ao [RFC 8707: Indicadores de recurso para OAuth 2.0](https://datatracker.ietf.org/doc/html/rfc8707), que é um padrão para indicar o recurso que um cliente deseja acessar.
...
[^4]: O Auth0 suporta tokens de atualização multi-recurso (MRRT), mas não o RFC 8707 completo. O suporte ao indicador de recurso é limitado e não segue o padrão.

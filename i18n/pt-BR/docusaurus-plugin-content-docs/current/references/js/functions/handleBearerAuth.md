...
`verifyAccessToken` fornecida e checa o emissor, público e escopos necessários.
...
- Se a verificação do token de acesso falhar, responde com um erro 401 Não autorizado.
- Se o token não possuir os escopos necessários, responde com um erro 403 Proibido.
- Se ocorrerem erros inesperados durante o processo de autenticação, o middleware irá relançá-los.

...
#### 參考 {#see}
 ...
 - [OAuth 2.0 授權伺服器中繼資料 (OAuth 2.0 Authorization Server Metadata)](https://datatracker.ietf.org/doc/html/rfc8414)
...
[AuthServerType](/references/js/type-aliases/AuthServerType.md) 以瞭解所有可能值。
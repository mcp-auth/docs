...
| [Asgardeo](https://wso2.com/asgardeo)                     | OpenID Connect | ✅        | ✅           | ⚠️[^5]                      | ❌                     |
...
[^5]: While Asgardeo supports dynamic client registration, its registration endpoint requires an access token with the necessary permissions, preventing MCP clients from registering directly.

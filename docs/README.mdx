...
- The provider can issue JWT access tokens bound to your MCP server ([RFC 8707](https://datatracker.ietf.org/doc/html/rfc8707)) — usually a matter of registering your server's identifier as a resource or audience.

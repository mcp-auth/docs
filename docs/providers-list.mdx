...
1. If you are developing an MCP server for internal use or a specific application that you control, it's fine manually register your MCP client with the provider and configure the client ID (and optionally client secret) in your MCP client.
2. If you are developing an MCP server that will be used by public or multiple applications:

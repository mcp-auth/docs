...
:::info
Check out the [MCP Auth Node.js SDK repository](https://github.com/mcp-auth/js/blob/master/samples/server/whoami.ts) for the complete code of the MCP server.
:::
